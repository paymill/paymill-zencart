...
class paymill_abstract extends base  implements Services_Paymill_LoggingInterface
{
    ...
    function before_process()
    {
        ...
        $this->paymentProcessor->setDescription(substr((string) STORE_NAME, 0, 128));
    ...
    function after_process()
    {
        ...
        $db->Execute("INSERT INTO " . DB_PREFIX . "pi_paymill_transaction (order_id, transaction_id, amount, payment_code) VALUES ('" . zen_db_prepare_input($insert_id) . "', '" . zen_db_prepare_input($_SESSION['paymill']['transaction_id']) . "', '" . (int) $this->format_raw($order->info['total']) . "', '" . zen_db_prepare_input($this->code) . "')");
