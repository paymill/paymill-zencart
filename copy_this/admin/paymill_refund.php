...
if (isset($_GET['oID']) && !empty($_GET['oID'])) {
    ...
    $params = array(
        ...
        'source' => $payment->version . '_ZENCART_' . PROJECT_VERSION_MAJOR . '.' . PROJECT_VERSION_MINOR,
    ...
    if (isset($refund['response_code']) && $refund['response_code'] == 20000) {
        ...
        $db->Execute("UPDATE " . TABLE_ORDERS . " SET orders_status='" . $statusArray->fields['orders_status_id'] . "' WHERE orders_id='" . $_GET['oID'] . "'");
