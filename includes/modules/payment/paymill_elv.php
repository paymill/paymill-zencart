...
class paymill_elv extends paymill_abstract
{
    ...
    function pre_confirmation_check()
    {
        ...
        $script = '<script type="text/javascript">'
                ...
                . 'var paymill_account_name = ' . json_encode(zen_output_string_protected($order->billing['firstname'] . ' ' . $order->billing['lastname'])) . ';'
    ...
    function check()
    {
        if (!isset($this->_check)) {
            $check_query = zen_db_query("SELECT configuration_value FROM " . TABLE_CONFIGURATION . " WHERE configuration_key = 'MODULE_PAYMENT_PAYMILL_ELV_STATUS'");
