...
define('MODULE_PAYMENT_PAYMILL_ELV_PUBLICKEY_TITLE', 'Öffentlicher API Key');
...
define('MODULE_PAYMENT_PAYMILL_ELV_ZONE_TITLE', 'Erlaubt für Zonen');
define('MODULE_PAYMENT_PAYMILL_ELV_ZONE_DESC', 'Für alle Zonen leer lassen');
define('MODULE_PAYMENT_PAYMILL_ELV_TRANS_ORDER_STATUS_ID_TITLE', 'API Ergebnisse');
define('MODULE_PAYMENT_PAYMILL_ELV_TRANS_ORDER_STATUS_ID_DESC', 'API Ergebnisse in diesem Bestellstatus für Bestellungen speichern.');
